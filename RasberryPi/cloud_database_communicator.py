...
def push_data(data, product_id):
    ...
    ref = db.reference('https://potbot-9f9ff-default-rtdb.europe-west1.firebasedatabase.app/users/ffJEWDC2nfMi6BFu7fS1mKkRXnC3/plants/Parasollpilea/measureData')
