  ...
  return (
    <div className="about module">
      ...
      <div className="about-content">
        ...
        <p>In case of watering needs, the user can opt for automatic watering, made possible with a built-in wateringp         system and when the plant is in need of care, the user is notified about the environmental data. </p>
        <p>Through the official application, the user can access all their PotBots and monitor and interact with allp         their plants from a single application. In addition, the PotBot helps promote optimal plant health by
